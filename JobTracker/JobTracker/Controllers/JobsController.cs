...
namespace JobTracker.Controllers
{
    public class JobsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["ContactId"] = new SelectList(_context.Contact, "ContactId", "CompanyId");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("JobId,Title,Notes,CompanyId,ContactId")] Job job)
        {
            ...
            ViewData["ContactId"] = new SelectList(_context.Contact, "ContactId", "CompanyId", job.ContactId);
            return View(job);
        }
